...
class saxpyDF(PtrsIn: Seq[Int] = List(64, 64), ValsIn: Seq[Int] = List(64, 64), Returns: Seq[Int] = List(64))
  ...
  val icmp_cmp112 = Module(new ComputeNode(NumOuts = 1, ID = 2, opCode = "sgt")(sign = true, Debug = false))
  ...
  icmp_cmp112.io.enable <> bb_entry1.io.Out(1)
  ...
  icmp_cmp112.io.RightIO <> const0.io.Out
  ...
  br_3.io.CmpIO <> icmp_cmp112.io.Out(0)
  ...
  icmp_cmp112.io.LeftIO <> ArgSplitter.io.Out.dataVals.elements("field0")(0)
