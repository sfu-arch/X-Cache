...
class test10DF(PtrsIn: Seq[Int] = List(64, 64, 64), ValsIn: Seq[Int] = List(), Returns: Seq[Int] = List())
			(implicit p: Parameters) extends DandelionAccelDCRModule(PtrsIn, ValsIn, Returns){

  /**
    * Call Interfaces
    */
  val call_7_out_io = IO(Decoupled(new CallDCR(ptrsArgTypes = List(), valsArgTypes = List(64, 64))))
  val call_7_in_io = IO(Flipped(Decoupled(new Call(List(64)))))
  ...
  //  %call = tail call i32 @test10_add(i32 %0, i32 %1), !dbg !42, !UID !43
  val call_7_out = Module(new CallOutDCRNode(ID = 7, NumSuccOps = 0, PtrsTypes = List(), ValsTypes = List(64, 64)))

  val call_7_in = Module(new CallInNode(ID = 7, argTypes = List(64)))
  ...
  //  store i32 %call, i32* %arrayidx4, align 4, !dbg !46, !tbaa !34, !UID !47
  ...
  val br_12 = Module(new CBranchNodeVariable(NumTrue = 1, NumFalse = 1, NumPredecessor = 2, ID = 12))
  ...
  call_7_in.io.enable <> bb_for_body2.io.Out(9)

  call_7_out.io.enable <> bb_for_body2.io.Out(8)


  Gep_arrayidx48.io.enable <> bb_for_body2.io.Out(10)


  st_9.io.enable <> bb_for_body2.io.Out(11)


  binaryOp_indvars_iv_next10.io.enable <> bb_for_body2.io.Out(12)


  icmp_exitcond11.io.enable <> bb_for_body2.io.Out(13)


  br_12.io.enable <> bb_for_body2.io.Out(14)
  ...
  call_7_out.io.inVals.elements("field0") <> ld_4.io.Out(0)

  ld_6.io.GepAddr <> Gep_arrayidx25.io.Out(0)

  call_7_out.io.inVals.elements("field1") <> ld_6.io.Out(0)
  ...
  call_7_out_io <> call_7_out.io.Out(0)

  call_7_in.io.In <> call_7_in_io

  br_12.io.PredOp(1) <> call_7_in.io.Out.enable
