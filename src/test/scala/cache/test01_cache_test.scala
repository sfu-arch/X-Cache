...
class test_cache01Test01[T <: test_cache01MainIO](c: T) extends PeekPokeTester(c) {
  ...
  val inDataVec = List.range(0, 20, 1)
  val outAddrVec = List.range(0, (4 * 20), 4)
  ...
  val outDataVec = List(0, 4, 12, 24, 8, 20, 36, 56,
    16, 36, 60, 88, 24, 52, 84, 120, 32, 68, 108, 152)
  ...
  poke(c.io.in.bits.data("field1").data, 20) // Array a[] base address
