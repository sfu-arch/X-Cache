...
class cilk_for_test06MainDirect(implicit p: Parameters) extends cilk_for_test06MainIO()(p) {
  ...
  val cilk_for_test06 = Module(new cilk_for_test06CacheWrapper())
  val cilk_for_test06_detach = Module(new cilk_for_test06_detachDF())
  val cilk_for_test06_detach_2 = Module(new cilk_for_test06_detach_2DF())

  cilk_for_test06.io.in <> io.in
  cilk_for_test06_detach.io.in <> cilk_for_test06.io.call9_out
  cilk_for_test06_detach_2.io.in <> cilk_for_test06_detach.io.call10_out
  cilk_for_test06_detach.io.call10_in <> cilk_for_test06_detach_2.io.out
...
class cilk_for_test06MainTM(implicit p: Parameters) extends cilk_for_test06MainIO()(p) {
  ...
  val cilk_for_test06_detach_2 = for (i <- 0 until children) yield {
    val detach_2 = Module(new cilk_for_test06_detach_2DF)
    detach_2
  }
  ...
  for (i <- 0 until children ) {
    ...
    cilk_for_test06_detach_2(i).io.in <> cilk_for_test06_detach(i).io.call10_out
    cilk_for_test06_detach(i).io.call10_in <> cilk_for_test06_detach_2(i).io.out
