...
class cilk_for_test01Test01(c: cilk_for_test01CacheWrapper) extends PeekPokeTester(c) {


  /**
  *  cilk_for_test01DF interface:
  *
...
class cilk_for_test01Tester extends FlatSpec with Matchers {
  ...
  it should "Check that cilk_for_test01 works correctly." in {
    ...
    chisel3.iotesters.Driver.execute(
     Array(
       ...
       "-td", "test_run_dir",
       "-tts", "0001"),
     () => new cilk_for_test01CacheWrapper()) {
