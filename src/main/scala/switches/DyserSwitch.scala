...
class Dyser (implicit p: Parameters) extends DyserIO()(p) {
  //Five 4:1 Muxes
  val DMuxN = Module(new DyserMux(NInputs = 4, Sel = 1, En = true.B)(p))
  val DMuxE = Module(new DyserMux(NInputs = 4, Sel = 1, En = true.B)(p))
//  val DMuxW = Module(new DyserMux(NInputs = 4, Sel = 1, En = true.B)(p))
//  val DMuxS = Module(new DyserMux(NInputs = 4, Sel = 1, En = true.B)(p))
//  val DMuxNE = Module(new DyserMux(NInputs = 4, Sel = 1, En = true.B)(p))
//
//  //Three 5:1 Muxes
//
//  val DMuxNW = Module(new DyserMux(NInputs = 5, Sel = 1, En = true.B)(p))
//  val DMuxSW = Module(new DyserMux(NInputs = 5, Sel = 1, En = true.B)(p))
//  val DMuxSE = Module(new DyserMux(NInputs = 5, Sel = 1, En = true.B)(p))
