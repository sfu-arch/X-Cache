...
abstract class __offload_func_5DFIO(implicit val p: Parameters) extends Module with CoreParams {
...
class __offload_func_5DF(implicit p: Parameters) extends __offload_func_5DFIO()(p) {
   ...
   * ================================================================== */
	...
	val StackFile = Module(new TypeStackFile(ID=0,Size=32,NReads=19,NWrites=19)
		            (WControl=new WriteMemoryController(NumOps=19,BaseSize=2,NumEntries=2))
  ...
  val m_55 = Module(new UnTypStore(NumPredOps=0, NumSuccOps=0, NumOuts=1,ID=55,RouteID=18))
  ...
  val m_60 = Module(new UnTypStore(NumPredOps=0, NumSuccOps=0, NumOuts=1,ID=60,RouteID=18))
  ...
  m_55.io.inData <> m_53.io.Out(param.m_55_in("m_53"))
  m_55.io.memResp  <> StackFile.io.WriteOut(18)
  StackFile.io.WriteIn(18) <> m_55.io.memReq
  ...
  // Wiring Store instruction to the parent instruction
  m_60.io.inData <> m_56.io.Out(param.m_60_in("m_56"))
  m_60.io.memResp  <> StackFile.io.WriteOut(18)
  StackFile.io.WriteIn(18) <> m_60.io.memReq
