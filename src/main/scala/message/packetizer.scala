...
class PacketizerIO [T<: IntraNodeBundle](MB : T) (implicit val p: Parameters) extends Bundle with MessageParams {
...
class Packetizer [T <: IntraNodeBundle](MB : T) (implicit val p: Parameters) extends Module with MessageParams{
