...
class k3mmDF(implicit p: Parameters) extends k3mmDFIO()(p) {
  ...
  val icmp_20 = Module(new ComputeNode(NumOuts = 1, ID = 20, opCode = "eq")(sign = false))
  ...
  val icmp_48 = Module(new ComputeNode(NumOuts = 1, ID = 48, opCode = "eq")(sign = false))
  ...
  val icmp_76 = Module(new ComputeNode(NumOuts = 1, ID = 76, opCode = "eq")(sign = false))
  ...
  val icmp_79 = Module(new ComputeNode(NumOuts = 1, ID = 79, opCode = "eq")(sign = false))
  ...
  val icmp_82 = Module(new ComputeNode(NumOuts = 1, ID = 82, opCode = "eq")(sign = false))
