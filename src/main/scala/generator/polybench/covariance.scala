...
class kernel_covarianceDF(implicit p: Parameters) extends kernel_covarianceDFIO()(p) {
  ...
  val Loop_0 = Module(new LoopBlock(NumIns = List(2, 1, 1, 1), NumOuts = 1, NumExits = 1, ID = 0))

  val Loop_1 = Module(new LoopBlock(NumIns = List(4, 2, 1, 1), NumOuts = 0, NumExits = 1, ID = 1))

  val Loop_2 = Module(new LoopBlock(NumIns = List(1, 1, 1), NumOuts = 0, NumExits = 1, ID = 2))

  val Loop_3 = Module(new LoopBlock(NumIns = List(1, 1, 1), NumOuts = 0, NumExits = 1, ID = 3))

  val Loop_4 = Module(new LoopBlock(NumIns=List(1,1), NumOuts = 0, NumExits=1, ID = 4))

  val Loop_5 = Module(new LoopBlock(NumIns = List(1, 1, 1), NumOuts = 1, NumExits = 1, ID = 5))
  ...
  val bb_for_body32 = Module(new LoopHead(NumOuts = 15, NumPhi = 2, BID = 2))

  val bb_for_end3 = Module(new BasicBlockNode(NumInputs = 1, NumOuts = 8, NumPhi = 1, BID = 3))

  val bb_for_cond14_preheader_preheader4 = Module(new BasicBlockNoMaskNode(NumInputs = 1, NumOuts = 1, BID = 4))

  val bb_for_cond14_preheader5 = Module(new LoopHead(NumOuts = 3, NumPhi = 1, BID = 5))

  val bb_for_cond26_preheader6 = Module(new BasicBlockNoMaskNode(NumInputs = 1, NumOuts = 3, BID = 6))

  val bb_for_body167 = Module(new LoopHead(NumOuts = 15, NumPhi = 1, BID = 7))

  val bb_for_inc238 = Module(new BasicBlockNoMaskNode(NumInputs = 1, NumOuts = 5, BID = 8))

  val bb_for_body31_preheader9 = Module(new LoopHead(NumOuts = 3, NumPhi = 1, BID = 9))

  val bb_for_body3110 = Module(new LoopHead(NumOuts = 7, NumPhi = 1, BID = 10))

  val bb_for_body3611 = Module(new LoopHead(NumOuts = 20, NumPhi = 2, BID = 11))
  ...
  val phi_j_0101 = Module(new PhiFastNode(NumInputs = 2, NumOutputs = 3, ID = 1))
  ...
  val phi_5 = Module(new PhiFastNode(NumInputs = 2, NumOutputs = 1, ID = 5))

  //  %i.09 = phi i32 [ 0, %for.body ], [ %inc, %for.body3 ]
  val phi_i_096 = Module(new PhiFastNode(NumInputs = 2, NumOutputs = 2, ID = 6))
  ...
  val phi_i_1822 = Module(new PhiFastNode(NumInputs = 2, NumOutputs = 2, ID = 22))
  ...
  val phi_j_1726 = Module(new PhiFastNode(NumInputs = 2, NumOutputs = 3, ID = 26))
  ...
  val br_36 = Module(new CBranchFastNodeVariable(NumTrue = 1, NumFalse = 2, ID = 36))
  ...
  val phi_j_2442 = Module(new PhiFastNode(NumInputs = 2, NumOutputs = 4, ID = 42))
  ...
  val phi_k_0248 = Module(new PhiFastNode(NumInputs = 2, NumOutputs = 3, ID = 48))
  ...
  val br_60 = Module(new CBranchFastNodeVariable(NumTrue = 1, NumFalse = 2, ID = 60))

  //  %add43.lcssa = phi double [ %add43, %for.body36 ]
  val phi_add43_lcssa61 = Module(new PhiFastNode(NumInputs = 1, NumOutputs = 1, ID = 61))
  ...
  bb_for_inc5813.io.predicateIn <> Loop_1.io.endEnable

  bb_for_end6014.io.predicateIn <> Loop_2.io.endEnable
  ...
  Loop_0.io.In(3) <> Gep_tmp544.io.Out.data(1)
  ...
  phi_j_2442.io.InData(1) <> Loop_1.io.liveIn.data("field0")(0)
  ...
  phi_j_0101.io.enable <> bb_for_body1.io.Out(2)
  ...
  constf1.io.enable <> bb_for_body32.io.Out(0)

  const1.io.enable <> bb_for_body32.io.Out(1)
  ...
  phi_5.io.enable <> bb_for_body32.io.Out(5)

  phi_i_096.io.enable <> bb_for_body32.io.Out(6)

  Gep_tmp7.io.enable <> bb_for_body32.io.Out(7)

  Gep_tmp18.io.enable <> bb_for_body32.io.Out(8)

  ld_9.io.enable <> bb_for_body32.io.Out(9)

  FP_add10.io.enable <> bb_for_body32.io.Out(10)

  st_11.io.enable <> bb_for_body32.io.Out(11)

  binaryOp_inc12.io.enable <> bb_for_body32.io.Out(12)

  icmp_exitcond1613.io.enable <> bb_for_body32.io.Out(13)

  br_14.io.enable <> bb_for_body32.io.Out(14)
  ...
  const7.io.enable <> bb_for_cond14_preheader5.io.Out(0)

  phi_i_1822.io.enable <> bb_for_cond14_preheader5.io.Out(1)

  br_23.io.enable <> bb_for_cond14_preheader5.io.Out(2)


  constf2.io.enable <> bb_for_cond26_preheader6.io.Out(0)

  FP_sub4724.io.enable <> bb_for_cond26_preheader6.io.Out(1)

  br_25.io.enable <> bb_for_cond26_preheader6.io.Out(2)


  const8.io.enable <> bb_for_body167.io.Out(0)

  const9.io.enable <> bb_for_body167.io.Out(1)

  const10.io.enable <> bb_for_body167.io.Out(2)

  const11.io.enable <> bb_for_body167.io.Out(3)

  phi_j_1726.io.enable <> bb_for_body167.io.Out(4)

  Gep_arrayidx1727.io.enable <> bb_for_body167.io.Out(5)

  ld_28.io.enable <> bb_for_body167.io.Out(6)

  Gep_tmp229.io.enable <> bb_for_body167.io.Out(7)

  Gep_tmp330.io.enable <> bb_for_body167.io.Out(8)

  ld_31.io.enable <> bb_for_body167.io.Out(9)

  binaryOp_sub32.io.enable <> bb_for_body167.io.Out(10)

  st_33.io.enable <> bb_for_body167.io.Out(11)

  binaryOp_inc2134.io.enable <> bb_for_body167.io.Out(12)

  icmp_exitcond1435.io.enable <> bb_for_body167.io.Out(13)

  br_36.io.enable <> bb_for_body167.io.Out(14)
  ...
  const14.io.enable <> bb_for_body31_preheader9.io.Out(0)

  phi_i_2540.io.enable <> bb_for_body31_preheader9.io.Out(1)

  br_41.io.enable <> bb_for_body31_preheader9.io.Out(2)
  ...
  phi_i_1822.io.InData(1) <> const7.io.Out
  ...
  st_3.io.GepAddr <> Gep_arrayidx2.io.Out.data(0)

  st_17.io.GepAddr <> Gep_arrayidx2.io.Out.data(2)
  ...
  FP_add10.io.RightIO <> ld_9.io.Out.data(0)
  ...
  ld_28.io.GepAddr <> Gep_arrayidx1727.io.Out.data(0)

  binaryOp_sub32.io.RightIO <> ld_28.io.Out.data(0)

  Gep_tmp330.io.baseAddress <> Gep_tmp229.io.Out.data(0)

  ld_31.io.GepAddr <> Gep_tmp330.io.Out.data(0)

  st_33.io.GepAddr <> Gep_tmp330.io.Out.data(1)

  binaryOp_sub32.io.LeftIO <> ld_31.io.Out.data(0)
  ...
  phi_i_1822.io.InData(0) <> binaryOp_inc2437.io.Out(0)
  ...
  Gep_tmp544.io.baseAddress <> Gep_tmp443.io.Out.data(0)

  st_45.io.GepAddr <> Gep_tmp544.io.Out.data(0)

  st_63.io.GepAddr <> Gep_tmp544.io.Out.data(2)
  ...
  Gep_tmp750.io.baseAddress <> Gep_tmp649.io.Out.data(0)

  ld_51.io.GepAddr <> Gep_tmp750.io.Out.data(0)

  binaryOp_mul55.io.LeftIO <> ld_51.io.Out.data(0)

  Gep_tmp953.io.baseAddress <> Gep_tmp852.io.Out.data(0)

  ld_54.io.GepAddr <> Gep_tmp953.io.Out.data(0)

  binaryOp_mul55.io.RightIO <> ld_54.io.Out.data(0)
  ...
  Gep_tmp1165.io.baseAddress <> Gep_tmp1064.io.Out.data(0)

  st_66.io.GepAddr <> Gep_tmp1165.io.Out.data(0)

  phi_j_2442.io.InData(0) <> binaryOp_inc5667.io.Out(0)
