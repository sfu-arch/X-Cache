...
abstract class cilk_for_test01DFIO(implicit val p: Parameters) extends Module with HasAccelParams {
...
class cilk_for_test01DF(implicit p: Parameters) extends cilk_for_test01DFIO()(p) {
  ...
  //  %__begin.011 = phi i32 [ 0, %entry ], [ %inc, %pfor.inc ], !UID !14
  val phi__begin_0112 = Module(new PhiFastNode(NumInputs = 2, NumOutputs = 2, ID = 2, Res = true))
  ...
  phi__begin_0112.io.InData(1) <> Loop_0.io.CarryDepenOut.elements("field0")(0)
  ...
  phi__begin_0112.io.Mask <> bb_pfor_detach2.io.MaskBB(0)
  ...
  phi__begin_0112.io.InData(0) <> const0.io.Out
...
object cilk_for_test01Top extends App {
  val dir = new File("RTL/cilk_for_test01Top");
  dir.mkdirs
