...
class cilk_for_test12_detach1DF(implicit p: Parameters) extends cilk_for_test12_detach1DFIO( )(p) {
  ...
  */
  ...
  // Wiring Call to I/O
  callout18.io.In.elements("field0") <> lb_L_0.io.liveIn.elements("field0")(1) // manual
  callout18.io.In.elements("field1") <> lb_L_0.io.liveIn.elements("field1")(0) // manual
  ...
  // Reattach (Manual add)
  reattach19.io.predicateIn(0) <> callin18.io.Out.data.elements("field0")
...
object cilk_for_test12_detach1Main extends App {
  val dir = new File("RTL/cilk_for_test12_detach1");
  dir.mkdirs
