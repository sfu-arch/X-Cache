...
abstract class cilk_for_test06DFIO(implicit val p: Parameters) extends Module with HasAccelParams {
...
class cilk_for_test06DF(implicit p: Parameters) extends cilk_for_test06DFIO()(p) {
  ...
  //  call void @cilk_for_test06_detach1([2 x i32]* %p1, i32 %__begin.037, [2 x i32]* %p2, i32* %d), !UID !25
