...
//  br6.io.Out(0).ready := true.B
  ...
  loop_L_5_liveIN_0.io.enable <> bb_pfor_end14.io.Out(1)
  loop_L_5_liveIN_1.io.enable <> bb_pfor_end14.io.Out(2)
  loop_L_5_liveIN_2.io.enable <> bb_pfor_end14.io.Out(3)
