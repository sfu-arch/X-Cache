...
abstract class cilk_for_test07DFIO(implicit val p: Parameters) extends Module with HasAccelParams {
...
object cilk_for_test07Top extends App {
  val dir = new File("RTL/cilk_for_test07Top");
  dir.mkdirs
