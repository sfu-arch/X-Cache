...
abstract class cilk_for_test03_detach1DFIO(implicit val p: Parameters) extends Module with CoreParams {
...
object cilk_for_test03_detach1Top extends App {
  val dir = new File("RTL/cilk_for_test03_detach1Top");
  dir.mkdirs
  implicit val p = Parameters.root((new MiniConfig).toInstance)
  val chirrtl = firrtl.Parser.parse(chisel3.Driver.emit(() => new cilk_for_test03_detach1DF()))
