...
class cilk_for_test04DF(implicit p: Parameters) extends cilk_for_test04DFIO()(p) {
  ...
  //  br label %pfor.cond, !UID !7, !BB_UID !8
  val br_0 = Module(new UBranchNode(ID = 0))

  //  %i.0 = phi i32 [ 0, %entry ], [ %inc, %pfor.inc ], !UID !9
  ...
  //  detach label %offload.pfor.body, label %pfor.inc, !UID !13, !BB_UID !14
  ...
  reattach_10.io.predicateIn(0) <> call_9_in.io.Out.elements("field0") // manual
