...
object Data_cilk_for_test10_inner_FlowParam{
...
abstract class cilk_for_test10_innerDFIO(implicit val p: Parameters) extends Module with CoreParams {
...
class cilk_for_test10_innerDF(implicit p: Parameters) extends cilk_for_test10_innerDFIO()(p) {
...
*/
  ...
  /**
    ...
    */
  val param = Data_cilk_for_test10_inner_FlowParam
...
object cilk_for_test10_innerMain extends App {
  val dir = new File("RTL/cilk_for_test10_inner") ; dir.mkdirs
  implicit val p = config.Parameters.root((new MiniConfig).toInstance)
  val chirrtl = firrtl.Parser.parse(chisel3.Driver.emit(() => new cilk_for_test10_innerDF()))
