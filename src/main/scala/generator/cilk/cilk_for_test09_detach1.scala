...
abstract class cilk_for_test09_detach1DFIO(implicit val p: Parameters) extends Module with CoreParams {
...
class cilk_for_test09_detach1DF(implicit p: Parameters) extends cilk_for_test09_detach1DFIO()(p) {
  ...
  val bb_my_pfor_body0 = Module(new BasicBlockNoMaskFastNode(NumInputs = 1, NumOuts = 4, BID = 0))
  ...
  ld_0.io.enable <> bb_my_pfor_body0.io.Out(0)


  binaryOp_1.io.enable <> bb_my_pfor_body0.io.Out(1)


  st_2.io.enable <> bb_my_pfor_body0.io.Out(2)


  ret_3.io.In.enable <> bb_my_pfor_body0.io.Out(3)
  ...
  binaryOp_1.io.RightIO <> InputSplitter.io.Out.data.elements("field1")(0)
...
object cilk_for_test09_detach1Top extends App {
  val dir = new File("RTL/cilk_for_test09_detach1Top");
  dir.mkdirs
  implicit val p = config.Parameters.root((new MiniConfig).toInstance)
  val chirrtl = firrtl.Parser.parse(chisel3.Driver.emit(() => new cilk_for_test09_detach1DF()))
