...
class test03DF(implicit p: Parameters) extends test03DFIO()(p) {
  ...
  val Loop_0 = Module(new LoopBlockNode(NumIns = List(1, 1, 2), NumOuts = List(1), NumCarry = List(1, 1), NumExits = 1, ID = 0))
  ...
  phi4.io.InData(1) <> Loop_0.io.OutLiveIn.elements("field2")(0)

  binaryOp_5.io.RightIO <> Loop_0.io.OutLiveIn.elements("field2")(1)

  binaryOp_6.io.RightIO <> Loop_0.io.OutLiveIn.elements("field1")(0)

  icmp_8.io.RightIO <> Loop_0.io.OutLiveIn.elements("field0")(0)
  ...
  icmp_0.io.LeftIO <> InputSplitter.io.Out.data.elements("field2")(1)
