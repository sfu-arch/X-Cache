...
class test03DF(implicit p: Parameters) extends test03DFIO()(p) {
  ...
  Loop_0.io.InLiveOut(0) <> binaryOp_15.io.Out(0)
  ...
  phi5.io.InData(1) <> Loop_0.io.OutLiveOut.elements("field0")(0)

  phi4.io.InData(1) <> Loop_0.io.OutLiveOut.elements("field1")(0)
  ...
  Loop_0.io.CarryDepenIn(0) <> binaryOp_15.io.Out(1)

  Loop_0.io.CarryDepenIn(1) <> binaryOp_13.io.Out(1)
  ...
  phi9.io.InData(0) <> Loop_0.io.CarryDepenOut.elements("field0")(0)

  phi10.io.InData(0) <> Loop_0.io.CarryDepenOut.elements("field1")(0)
