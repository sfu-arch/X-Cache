...
//  for_cond_expand.io.InData <> br4.io.Out(param.br4_brn_bb("for_end"))
  ...
  phi1.io.InData(0) <> loop_L_5_liveIN_0.io.Out(0)

  phi1.io.InData(param.phi1_phi_in("add5")) <> add5.io.Out(0)
  ...
  phi2.io.InData(param.phi2_phi_in("add7")) <> add7.io.Out(0)
  ...
  loop_L_5_end.io.inputArg(0) <> phi1.io.Out(1)
