...
object Data_test11_FlowParam{
  ...
  //  %call = tail call i32 @test11_add(i32 %0, i32 %1), !UID !26, !ScalaLabel !27
  val call8_in = Map(
    "load5" -> 0,
    "load7" -> 0,
    "" -> 0
...
class test11DF(implicit p: Parameters) extends test11DFIO()(p) {
  ...
  //  %call = tail call i32 @test11_add(i32 %0, i32 %1), !UID !26, !ScalaLabel !27
  val call8 = Module(new CallNode(ID=8,argTypes=List(32,32),retTypes=List(32)))
  ...
  loop_L_10_liveIN_0.io.enable <> bb_for_end.io.Out(1)
  loop_L_10_liveIN_1.io.enable <> bb_for_end.io.Out(2)
  loop_L_10_liveIN_2.io.enable <> bb_for_end.io.Out(3)
