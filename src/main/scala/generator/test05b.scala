...
class test05bDF(implicit p: Parameters) extends test05bDFIO( )(p) {
  ...
  */
  ...
  //  ret i32 %1, !UID !38, !BB_UID !39, !ScalaLabel !40
  val ret16 = Module(new RetNode(retTypes = List(32), ID = 16))
...
*/
  ...
  icmp2.io.RightIO <> lb_L_0.io.liveIn.elements("field1")(0) // manual
  ...
  callin4.io.Out.data.elements("field0").ready := true.B // Manual fix
