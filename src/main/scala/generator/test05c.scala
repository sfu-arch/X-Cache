...
class test05cDF(implicit p: Parameters) extends test05cDFIO( )(p) {
  ...
  */
  ...
  callout5.io.In.elements("field0") <> lb_L_0.io.liveIn.elements("field0")(0) // manual
  callout5.io.In.elements("field1") <> lb_L_0.io.liveIn.elements("field1")(0) // manual
  ...
  // Wiring instructions
  add6.io.RightIO <> callin5.io.Out.data.elements("field0")
