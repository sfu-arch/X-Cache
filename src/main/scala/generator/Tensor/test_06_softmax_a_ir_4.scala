...
abstract class test_06_softmax_a_ir_4DFIO(implicit val p: Parameters) extends Module with CoreParams {
...
class test_06_softmax_a_ir_4DF(implicit p: Parameters) extends test_06_softmax_a_ir_4DFIO()(p) {
  ...
  //  %bitcast = bitcast i8* %arg0.untyped to [1 x [8 x float]]*, !UID !4
  ...
  //  %tmp = getelementptr [1 x [8 x float]], [1 x [8 x float]]* %bitcast, i64 0, i64 0, !UID !10
  val Gep_tmp6 = Module(new GepNode(NumIns = 2, NumOuts = 1, ID = 6)(ElementSize = 32, ArraySize = List(32)))

  //  %tmp1 = getelementptr [8 x float], [8 x float]* %tmp, i64 0, i64 %reduce.inner.indvar.reduction_dim.112, !UID !11
  val Gep_tmp17 = Module(new GepNode(NumIns = 2, NumOuts = 1, ID = 7)(ElementSize = 4, ArraySize = List(32)))
  ...
  val FPCMP_9 = Module(new FPCompareNode(NumOuts = 1, ID = 9, opCode = "or")(t = p(FTYP)))

  //  %4 = fcmp uno float %1, 0.000000e+00, !UID !14
  val FPCMP_10 = Module(new FPCompareNode(NumOuts = 1, ID = 10, opCode = "or")(t = p(FTYP)))
  ...
  //  %fusion.1 = bitcast i8* %10 to [1 x [8 x float]]*, !UID !26
  ...
  //  %tmp2 = getelementptr [1 x [8 x float]], [1 x [8 x float]]* %bitcast, i64 0, i64 0, !UID !30
  val Gep_tmp223 = Module(new GepNode(NumIns = 2, NumOuts = 1, ID = 23)(ElementSize = 32, ArraySize = List(32)))

  //  %tmp3 = getelementptr [8 x float], [8 x float]* %tmp2, i64 0, i64 %fusion.1.indvar.dim.18, !UID !31
  val Gep_tmp324 = Module(new GepNode(NumIns = 2, NumOuts = 1, ID = 24)(ElementSize = 4, ArraySize = List(32)))
  ...
  //  %tmp5 = getelementptr [8 x float], [8 x float]* %tmp4, i64 0, i64 %fusion.1.indvar.dim.18, !UID !36
  val Gep_tmp529 = Module(new GepNode(NumIns = 2, NumOuts = 1, ID = 29)(ElementSize = 4, ArraySize = List(32)))
  ...
  //  %16 = getelementptr inbounds i8, i8* %10, i64 32, !UID !42
  ...
  //  %tmp6 = getelementptr [1 x [8 x float]], [1 x [8 x float]]* %fusion.1, i64 0, i64 0, !UID !47
  val Gep_tmp638 = Module(new GepNode(NumIns = 2, NumOuts = 1, ID = 38)(ElementSize = 32, ArraySize = List(32)))

  //  %tmp7 = getelementptr [8 x float], [8 x float]* %tmp6, i64 0, i64 %reduce.1.inner.indvar.reduction_dim.14, !UID !48
  val Gep_tmp739 = Module(new GepNode(NumIns = 2, NumOuts = 1, ID = 39)(ElementSize = 4, ArraySize = List(32)))
  ...
  //  %fusion = bitcast i8* %0 to [8 x float]*, !UID !57
  ...
  //  %tmp8 = getelementptr [1 x [8 x float]], [1 x [8 x float]]* %fusion.1, i64 0, i64 0, !UID !61
  val Gep_tmp850 = Module(new GepNode(NumIns = 2, NumOuts = 1, ID = 50)(ElementSize = 32, ArraySize = List(32)))

  //  %tmp9 = getelementptr [8 x float], [8 x float]* %tmp8, i64 0, i64 %fusion.indvar.dim.02, !UID !62
  val Gep_tmp951 = Module(new GepNode(NumIns = 2, NumOuts = 1, ID = 51)(ElementSize = 4, ArraySize = List(32)))
  ...
  //i64 7
  val const5 = Module(new ConstFastNode(value = 7, ID = 5))
  ...
  //i64 7
  val const15 = Module(new ConstFastNode(value = 7, ID = 15))

  //i64 32
  val const16 = Module(new ConstFastNode(value = 32, ID = 16))
  ...
  //i64 7
  val const22 = Module(new ConstFastNode(value = 7, ID = 22))
  ...
  //i64 7
  val const29 = Module(new ConstFastNode(value = 7, ID = 29))
  ...
  Loop_1.io.CarryDepenIn(0) <> binaryOp_invar_inc642.io.Out(0)

  Loop_1.io.CarryDepenIn(1) <> FP_41.io.Out(1)
  ...
  phireduce_1_inner_indvar_reduction_dim_1437.io.InData(1) <> Loop_1.io.CarryDepenOut.elements("field0")(0)

  phi36.io.InData(1) <> Loop_1.io.CarryDepenOut.elements("field1")(0)
...
object test_06_softmax_a_ir_4Top extends App {
  ...
  val chirrtl = firrtl.Parser.parse(chisel3.Driver.emit(() => new test_06_softmax_a_ir_4DF()))
