...
class newDataFlow(implicit p: Parameters) extends myDataFlow()(p){
  ...
  val m0 = Module(new NewDecoupledNode(0, 0)(p))
  val m1 = Module(new NewDecoupledNode(0, 1)(p))
  val m2 = Module(new NewDecoupledNode(0, 2)(p))
  val m3 = Module(new NewDecoupledNode(0, 3)(p))
  val m4 = Module(new NewDecoupledNode(0, 4)(p))
  val m5 = Module(new NewDecoupledNode(0, 5)(p))
  val m6 = Module(new NewDecoupledNode(0, 6)(p))
