...
class ComputeFuse04SDF(implicit val p: Parameters) extends Module with HasAccelParams {
...
class ComputeFuse04PDF(implicit val p: Parameters) extends Module with HasAccelParams {
